...
public class Js_Parser extends Parser {
	...
	public static final int
		...
		RULE_statement = 4, RULE_if = 5, RULE_while = 6, RULE_for = 7, RULE_forin = 8, 
		RULE_forof = 9, RULE_doWhile = 10, RULE_return = 11, RULE_declare = 12, 
		RULE_assignmentRightHand = 13, RULE_arrowFunction = 14, RULE_normalFunction = 15, 
		RULE_functionCall = 16, RULE_expression = 17, RULE_assignment = 18, RULE_scopeHead = 19, 
		RULE_scopeBody = 20, RULE_block = 21, RULE_forExpression1 = 22, RULE_object = 23, 
		RULE_array = 24, RULE_args = 25, RULE_param = 26, RULE_returnable = 27, 
		RULE_incrementsOp = 28, RULE_multiplicativeOp = 29, RULE_additiveOp = 30, 
		RULE_assinmentOp = 31;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "line", "lineStart", "function", "statement", "if", "while", 
			"for", "forin", "forof", "doWhile", "return", "declare", "assignmentRightHand", 
			"arrowFunction", "normalFunction", "functionCall", "expression", "assignment", 
			"scopeHead", "scopeBody", "block", "forExpression1", "object", "array", 
			"args", "param", "returnable", "incrementsOp", "multiplicativeOp", "additiveOp", 
			"assinmentOp"
		};
	}
	...
	public final ForinContext forin() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_forin);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ForofContext forof() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_forof);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ScopeHeadContext scopeHead() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_scopeHead);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(244);
	...
	public final ScopeBodyContext scopeBody() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_scopeBody);
		try {
			setState(249);
			_errHandler.sync(this);
	...
	public final IncrementsOpContext incrementsOp() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_incrementsOp);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final AssinmentOpContext assinmentOp() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_assinmentOp);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
