...
public class Js_Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ID", "PRIM_TYPE", "DO", "FOR", "FUNCTION", "IF", "IN", "OF", "WHILE", 
			"DECLARERS", "INT", "FLOAT", "NUM", "STRING_ALLOWED_CHARS", "STRING", 
			"BOOL", "NULL", "UNDEFINED", "INCREMENT_OP", "DECREMENT_OP", "INCREMENTS_OP", 
			"LOGIC_NOT_OP", "POW_OP", "MULT_OP", "DIV_OP", "REM_OP", "MULTIPLICATIVE_OP", 
			"ADD_OP", "SUP_OP", "ADDITIVE_OP", "COMPARE_OP", "EQUAL_COMPARE_OP", 
			"AND", "OR", "NULL_COALES_OP", "ASSIGNMENT_OP", "COLON", "ADD_ASSIGN_OP", 
			"SUB_ASSIGN_OP", "MULT_ASSIGN_OP", "POW_ASSIGN_OP", "DIV_ASSIGN_OP", 
			"REM_ASSIGN_OP", "AND_ASSIGN_OP", "OR_ASSIGN_OP", "ASSIGNMENTS_OP", "ARROW", 
			"WS", "NEWLINE", "SEMICOLON", "LINE_END", "COMMA", "OPEN_BRACKET", "CLOSE_BRACKE", 
			"OPEN_SQUARE_BRACKET", "CLOSE_SQUARE_BRACKET", "OPEN_CURLY_BRACES", "CLOSE_CURLY_BRACES", 
			"MULTILINE_COMMENT", "LINE_COMMENT", "COMMENT"
		};
	}
