...
public class Js_Lexer extends Lexer {
	...
	public static final int
		...
		CONTINUE=12, DECLARERS=13, DO=14, FOR=15, FUNCTION=16, IF=17, IN=18, NEW=19, 
		OF=20, RETURN=21, THIS=22, WHILE=23, BOOL=24, INT=25, FLOAT=26, STRING=27, 
		NULL=28, UNDEFINED=29, INCREMENT_OP=30, DECREMENT_OP=31, LOGIC_NOT_OP=32, 
		POW_OP=33, MULT_OP=34, DIV_OP=35, REM_OP=36, ADD_OP=37, SUP_OP=38, COMPARE_OP=39, 
		EQUAL_COMPARE_OP=40, AND=41, OR=42, NULL_COALES_OP=43, TERNARY_OP1=44, 
		TERNARY_OP2=45, ASSIGNMENT_OP=46, ADD_ASSIGN_OP=47, SUB_ASSIGN_OP=48, 
		MULT_ASSIGN_OP=49, POW_ASSIGN_OP=50, DIV_ASSIGN_OP=51, REM_ASSIGN_OP=52, 
		AND_ASSIGN_OP=53, OR_ASSIGN_OP=54, NULL_ASSIGN_OP=55, ARROW=56, ID=57, 
		MULTILINE_COMMENT=58, LINE_COMMENT=59, NEWLINE=60, WS=61;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"OF", "RETURN", "THIS", "WHILE", "BOOL", "INT", "FLOAT", "STRING_ALLOWED_CHARS", 
			"STRING", "NULL", "UNDEFINED", "INCREMENT_OP", "DECREMENT_OP", "LOGIC_NOT_OP", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "':'", "','", "'.'", "'...'", "';'", "'('", "')'", "'['", "']'", 
			"'{'", "'}'", "'continue'", null, "'do'", "'for'", "'function'", "'if'", 
			"'in'", "'new'", "'of'", "'return'", "'this'", "'while'", null, null, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CLOSE_CURLY_BRACES", "CONTINUE", "DECLARERS", "DO", "FOR", "FUNCTION", 
			"IF", "IN", "NEW", "OF", "RETURN", "THIS", "WHILE", "BOOL", "INT", "FLOAT", 
			"STRING", "NULL", "UNDEFINED", "INCREMENT_OP", "DECREMENT_OP", "LOGIC_NOT_OP", 
			"POW_OP", "MULT_OP", "DIV_OP", "REM_OP", "ADD_OP", "SUP_OP", "COMPARE_OP", 
			"EQUAL_COMPARE_OP", "AND", "OR", "NULL_COALES_OP", "TERNARY_OP1", "TERNARY_OP2", 
			"ASSIGNMENT_OP", "ADD_ASSIGN_OP", "SUB_ASSIGN_OP", "MULT_ASSIGN_OP", 
